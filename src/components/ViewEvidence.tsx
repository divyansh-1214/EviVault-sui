...
export default function ViewEvidence({ packageId }: ViewEvidenceProps) {
    ...
    const fetchEvidence = async () => {
        ...
        try {
            ...
            // Call the get_evidence function
            const moveCallTxb = {
    ...
    return (
        <div className="max-w-2xl mx-auto">
            <h2 className="text-2xl font-semibold mb-6">View Evidence</h2>
            ...
            {evidence && (
                <div className="bg-white shadow rounded-lg p-6 space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <h3 className="text-sm font-medium text-gray-500">Evidence ID</h3>
                            <p className="mt-1 text-sm text-gray-900">{evidence.evidenceId}</p>
                        </div>
                        <div>
                            <h3 className="text-sm font-medium text-gray-500">Case Number</h3>
                            <p className="mt-1 text-sm text-gray-900">{evidence.caseNo}</p>
                        </div>
                        <div>
                            <h3 className="text-sm font-medium text-gray-500">FIR Number</h3>
                            <p className="mt-1 text-sm text-gray-900">{evidence.firNo}</p>
                        </div>
                        <div>
                            <h3 className="text-sm font-medium text-gray-500">Date</h3>
                            <p className="mt-1 text-sm text-gray-900">{evidence.date}</p>
                        </div>
                    </div>

                    <div>
                        <h3 className="text-sm font-medium text-gray-500">IPFS Hash</h3>
                        <p className="mt-1 text-sm text-gray-900 break-all">{evidence.ipfs}</p>
                    </div>

                    <div>
                        <h3 className="text-sm font-medium text-gray-500">Content</h3>
                        <p className="mt-1 text-sm text-gray-900 whitespace-pre-wrap">{evidence.content}</p>
                    </div>

                    <div>
                        <h3 className="text-sm font-medium text-gray-500">Head Address</h3>
                        <p className="mt-1 text-sm text-gray-900 break-all">{evidence.head}</p>
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <h3 className="text-sm font-medium text-gray-500">Latitude</h3>
                            <p className="mt-1 text-sm text-gray-900">{evidence.latitude}</p>
                        </div>
                        <div>
                            <h3 className="text-sm font-medium text-gray-500">Longitude</h3>
                            <p className="mt-1 text-sm text-gray-900">{evidence.longitude}</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-900">
                            {evidence.access ? 'Public' : 'Private'}
                        </p>
                    </div>
                </div>
            )}
